...
ggplot(variation_df) +
    ...
    labs(x = "Year", y = "Almond Yield Profit per Farm Acre", title = "Profit from Almond Yield in Varying Market Conditions", caption = "Profit models were run 5 times for each type to simulate different market conditions and uncertainty, indicated by 5 unique lines for each group.") +
